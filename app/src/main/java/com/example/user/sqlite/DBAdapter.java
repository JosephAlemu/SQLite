...
//
//
//    public static final String[] ALL_KEYS = new String[]{KEY_ROWID, KEY_FIRSTNAME, KEY_LASTNAME, KEY_TITLE,KEY_DESCRIPTION};
//
//    // DB info: it's name, and the table we are using (just one).
//    public static final String DATABASE_NAME = "my_db";
//    public static final String DATABASE_TABLE = "celebrity_table";
...
//    public long insertRow(String firstname, String lastname, String title,String description) {
//		/*
//		 * CHANGE 3:
//		 */
...
//    public boolean updateRow(long rowId, String firstname, String lastname, String title,String description) {
//        String where = KEY_ROWID + "=" + rowId;
//
//		/*
//		 * CHANGE 4:
